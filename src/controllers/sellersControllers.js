...
exports.facturacion = async (req, res) => {
  ...
  const allSellers = await conexion.query(
    "SELECT id_vendedor, ventasReales_individuales, ventasReales_afiliados, ventas_individuales, ventas_afiliados, total_ventas, ganancias FROM registro_de_vendedores"
  );
