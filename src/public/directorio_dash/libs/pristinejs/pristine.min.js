!(function (e, r) {
  ...
  function l(e, t, s) {
    ...
    function u(e) {
      for (var t, n = [], i = !0, s = 0; e.validators[s]; s++) {
        var a = e.validators[s],
          o = e.params[a.name] ? e.params[a.name] : [];
        if (((o[0] = e.input.value), !a.fn.apply(e.input, o))) {
          if (((i = !1), (t = a.msg) && t.constructor && t.call && t.apply))
            n.push(a.msg(e.input.value, o));
          else {
    ...
    function f(e) {
      ...
      return (
        (t =
          o.config.classTo === o.config.errorTextParent
            ? r
            : r.querySelector("." + o.config.errorTextParent)) &&
          ((n = t.querySelector(".pristine-error")) ||
            (((n = document.createElement(o.config.errorTextTag)).className =
              "pristine-error " + o.config.errorTextClass),
            t.appendChild(n),
    ...
    function c(e) {
      var r = f(e),
        ...
        n = r[1];
      t &&
        (t.classList.remove(o.config.successClass),
        t.classList.add(o.config.errorClass)),
        n &&
    ...
    function p(e) {
      var r = (function (e) {
        ...
        return (
          t &&
            (t.classList.remove(o.config.errorClass),
            t.classList.remove(o.config.successClass)),
          n && ((n.innerHTML = ""), (n.style.display = "none")),
          r
        );
      })(e)[0];
      r && r.classList.add(o.config.successClass);
    }
    return (
      (function (e, r, t) {
                ...
                [].forEach.call(e.attributes, function (e) {
                  if (/^data-pristine-/.test(e.name)) {
                    ...
                    if (s.endsWith("-message"))
                      return void (n[s.slice(0, s.length - 8)] = e.value);
                    "type" === s && (s = e.value), l(r, t, s, e.value);
                  } else ~i.indexOf(e.name) ? l(r, t, e.name, e.value) : "type" === e.name && l(r, t, e.value);
                }),
                r.sort(function (e, r) {
      ...
      (o.getErrors = function (e) {
        if (!e) {
          for (var r = [], t = 0; t < o.fields.length; t++) {
            var n = o.fields[t];
      ...
      (o.addValidator = function (e, r, t, n, i) {
        e instanceof HTMLElement
      ...
      (o.addError = function (e, r) {
        (e = e.length ? e[0] : e).pristine.errors.push(r), c(e.pristine);
      }),
      (o.reset = function () {
        for (var e = 0; o.fields[e]; e++) o.fields[e].errorElements = null;
        Array.from(o.form.querySelectorAll(".pristine-error")).map(function (
          e
        ) {
          e.parentNode.removeChild(e);
        }),
          Array.from(o.form.querySelectorAll("." + o.config.classTo)).map(
            function (e) {
  ...
  return (
    ...
    (l.addValidator = function (e, r, t, n, i) {
      o(e, { fn: r, msg: t, priority: n, halt: i });
    }),
    l
  );
});
