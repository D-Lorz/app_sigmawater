...
(function (g) {
  ...
  var z = function (a, e, b) {
      ...
      var c = {
        getCaret: function () {
          try {
            var d,
              ...
              e = c.selectionStart;
            if (h && !~navigator.appVersion.indexOf("MSIE 10"))
              (d = h.createRange()),
                d.moveStart(
                  "character",
        ...
        getRegexMask: function () {
          for (var d = [], f, a, c, b, l = 0; l < e.length; l++)
            (f = k.translation[e[l]])
              ? ((a = f.pattern.toString().replace(/.{1}$|^.{1}/g, "")),
                (c = f.optional),
                (f = f.recursive)
                  ? (d.push(e[l]), (b = { digit: e[l], pattern: a }))
                  : d.push(c || f ? a + "?" : a))
              : d.push("\\" + e[l]);
          d = d.join("");
          b &&
            (d = d
              .replace(RegExp("(" + b.digit + "(.*" + b.digit + ")?)"), "($1)?")
              .replace(RegExp(b.digit, "g"), b.pattern));
          return RegExp(d);
        },
        ...
        getMCharsBeforeCount: function (d, a) {
          for (var c = 0, b = 0, g = e.length; b < g && b < d; b++)
            k.translation[e.charAt(b)] || ((d = a ? d + 1 : d), c++);
          return c;
        },
        caretPos: function (d, a, b, h) {
          return k.translation[e.charAt(Math.min(d - 1, e.length - 1))]
            ? Math.min(d + b - a - h, b)
            : c.caretPos(d + 1, a, b, h);
        },
        ...
        callbacks: function (d) {
          var f = c.val(),
            g = f !== n;
          if (!0 === g && "function" === typeof b.onChange)
            b.onChange(f, d, a, b);
          if (!0 === g && "function" === typeof b.onKeyPress)
            b.onKeyPress(f, d, a, b);
          if ("function" === typeof b.onComplete && f.length === e.length)
            b.onComplete(f, d, a, b);
        },
      };
      k.remove = function () {
        var a;
  ...
  g.fn.mask = function (a, e) {
    var b = this.selector,
      k = function (b) {
        if (!b.originalEvent || g(b.originalEvent.relatedNode)[0] != g(this)[0])
          return g(this).data("mask", new z(this, a, e));
      };
    this.each(k);
    b &&
      !p[b] &&
